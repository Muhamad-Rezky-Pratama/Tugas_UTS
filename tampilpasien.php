...
<div class="main-content">
    ...
    <h2>Daftar Pasien</h2>
        <form method="POST" action="tambahpasien.php" class="mt-3">
    ...
    <table class="table table-dark table-hover text-center">
        ...
        <tbody>
            <?php 
            include 'koneksi.php';
            $data = mysqli_query($koneksi, "SELECT * FROM pasien ORDER BY ID_Pasien, ID_Dokter");
            while ($d = mysqli_fetch_array($data)) {
				...
				<td><?php echo $d['ID_Dokter']; ?></td>
                    <td>
                        <a role="button" class="btn btn-success" href="ubahpasien.php?id=<?php echo $d['ID_Pasien']; ?>">
                            <img src="icon/icon update2.png" alt="Edit" style="width: 16px; height: 16px; vertical-align: middle; margin-right: 5px;">UBAH
                        </a>
                        <a role="button" class="btn btn-danger" href="hapuspasien.php?id=<?php echo $d['ID_Pasien']; ?>">
