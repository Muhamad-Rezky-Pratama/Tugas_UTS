...
<body>
    ...
    <div class="mb-3" style="margin-left: 220px;">
        <form method="post" action="inputdokter.php">
            <table class="table">
                <tr>
                    <td>Nama Dokter</td>
                    <td><input class="form-control form-control-lg" type="text" name="Nama_dokter"></td>
                </tr>
                <tr>
                    <td>Kode Bidang</td>
                    <td><select class="form-control form-control-lg" id="ID_Bidang" name="ID_Bidang" required>
                            <?php
                            // Query untuk mengambil data pasien dari tabel pasien
                            $pasien = $koneksi->query("SELECT ID_Bidang, Nama_bidang FROM bidang");
                            ...
                            if ($pasien->num_rows > 0) {
                                ...
                                while ($row = $pasien->fetch_assoc()) {
                                    echo "<option value='" . $row['ID_Bidang'] . "'>" . $row['ID_Bidang'] . " - " . $row['Nama_bidang'] . "</option>";
                                }
                            } else {
                                // Jika tidak ada data pasien
                                echo "<option>Tidak ada data bidang</option>";
                            }
                            ?>
                        </select></td>
                </tr>
                <tr>
                    <td>No Telp</td>
                    <td><input class="form-control form-control-lg" type="text" name="No_telepon"></td>
                </tr>
                <tr>
                    <td>Jadwal</td>
                    <td><input class="form-control form-control-lg" type="text" name="Jadwal"></td>
                </tr>
                <tr>
                    <td colspan="3">
